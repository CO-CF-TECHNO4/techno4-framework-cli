  ...
  return indent(0, `
    <Page name="home">
      ...
      <Navbar large sliding={false}>
        <NavLeft>
          <Link iconIos="t4:menu" iconAurora="t4:menu" iconMd="material:menu" panelOpen="left" />
        </NavLeft>
        <NavTitle sliding>${name}</NavTitle>
        <NavRight>
          <Link iconIos="t4:menu" iconAurora="t4:menu" iconMd="material:menu" panelOpen="right" />
        </NavRight>
        <NavTitleLarge>${name}</NavTitleLarge>
      </Navbar>
      `.trim()}
