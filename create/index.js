...
${chalk.bold(logSymbols.info)} ${chalk.bold('Подальші кроки:')}
  ...
  - 👤 Стати учасником за посиланням ${chalk.bold('https://techno4.online/стати-учасником')}.
  - 📖 Шукайте документацію за посиланням ${chalk.bold('https://techno4.online/навчання/фреймворк')} для зареєстрованих учасників.
  - 📖 Читайте ${chalk.bold('README.md')} в файлах проекту для отримання інструкцій.

${chalk.bold('Подобається Techno4? Підтримайте проект.')}
    `;
